...
public static class DbSeeder
{
    public static void Seed(PharmacieDbContext db)
    {
        ...
        // Save pour stabiliser IDs / relations
        db.SaveChanges();

        // -----------------------------
        // 4) FournisseurProduits (chaque fournisseur fournit 25 à 60 produits)
        // -----------------------------
        ...
        for (int i = 1; i <= 40; i++)
        {
            ...
            foreach (var pr in chosenRefs)
            {
                ...
                var prixU = prod.Prix * (decimal)(0.65 + rng.NextDouble() * 0.25);
                ...
                // réception supposée => stock augmente
                prod.Quantite += qte;
            }
        ...
        // -----------------------------
        // 6) Ventes (80) + lignes (1 à 6) + facture 1-1
        // -----------------------------
